...
// 	eqPoll(t, Of(lessInt, 3, 1, 2), []int{1, 2, 3})
...
// 	})
// 	t.Run("peek is root", func(t *testing.T) {
// 		pq := FromSlice(lessInt, []int{3, 1, 2})
// 		top, ok := pq.Peek()
// 		testutil.EqVal(t, ok, true)
// 		testutil.EqVal(t, top, 1)
// 	})
...
// 	pq := &PriorityQueue[int]{less: lessInt}
// 	testutil.EqVal(t, pq.Len(), 0)
...
// func TestPopOrderMin(t *testing.T) {
// 	pq := Of(lessInt, 5, 1, 4, 2, 3)
// 	eqPoll(t, pq, []int{1, 2, 3, 4, 5})
// }

// func TestPopOrderMax(t *testing.T) {
// 	pq := Of(greaterInt, 5, 1, 4, 2, 3)
// 	eqPoll(t, pq, []int{5, 4, 3, 2, 1})
// }
...
// 	capBefore := cap(pq.items)
// 	pq.Clear()
// 	testutil.EqVal(t, pq.Len(), 0)
// 	testutil.EqVal(t, pq.IsEmpty(), true)
// 	if cap(pq.items) != capBefore {
// 		t.Fatalf("Clear should keep capacity: got %d, want %d", cap(pq.items), capBefore)
// 	}
// 	pq.Push(9)
// 	eqElems(t, pq, []int{9})
// }
...
// 		var vals []int
// 		for v := range Of(lessInt, 3, 1, 2).All() {
// 			vals = append(vals, v)
// 		}
// 		slices.Sort(vals)
...
// 		fn   func()
// 	}{
// 		{"New", func() { New[int](nil) }},
// 		{"Of", func() { Of[int](nil, 1) }},
// 		{"FromSlice", func() { FromSlice[int](nil, []int{1}) }},
// 	}
// 	for _, tc := range cases {
// 		t.Run(tc.name, func(t *testing.T) {
...
// 	t.Helper()
// 	got := sortedBy(pq.less, pq.ToSlice())
// 	testutil.Eq(t, got, sortedBy(pq.less, want))
// 	if len(want) == 0 {
